  ...
  return (
    <main>
      <header className='pokedex__header'>
        <h1>Pokedex</h1>
        <div className='pokedex__header-welcome'>
          <p>Welcome! <span className='pokedex__trainer'><strong>{nameTrainer}</strong></span>, here you can find your favorite pokemon <img className='trainer__img' src='/images/pokeball.png' alt='' /></p>
        </div>
